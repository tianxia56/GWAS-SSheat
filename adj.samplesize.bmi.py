...
bbj_input = './BBJ/BMI_BBJ_autosome.txt.gz'
bbj_output = './adj.GWAS/BMI.BBJ.adj'
ukbb_input = './UKBB/BMI_raw.gwas.imputed_v3.both_sexes.tsv.bgz'
ukbb_output = './adj.GWAS/BMI.UKBB.adj'
bbj_sample_size = 158284  # sample size for BBJ
ukbb_sample_size = 359983  # sample size for UKBB
