...
bbj_output = './adj.GWAS/Height.BBJ.adj'
ukbb_input = './UKBB/height_raw.gwas.imputed_v3.both_sexes.tsv.bgz'
ukbb_output = './adj.GWAS/Height.UKBB.adj'
bbj_sample_size = 159095  # Example sample size for BBJ
ukbb_sample_size = 360388  # Example sample size for UKBB
