...
# File paths
bbj_input = './BBJ/HDL-C.autosome.txt.gz'
bbj_output = './QC.GWAS/HDL.BBJ.QC'
ukbb_input = './UKBB/HDL_raw.gwas.imputed_v3.both_sexes.varorder.tsv.bgz'
ukbb_output = './QC.GWAS/HDL.UKBB.QC'
